...
sudo echo /opt/oracle/instantclient* > /etc/ld.so.conf.d/oracle-instantclient.conf
sudo ldconfig
sudo echo "DISABLE_OOB=ON" > $(echo /opt/oracle/instantclient*)/network/admin/sqlnet.ora
